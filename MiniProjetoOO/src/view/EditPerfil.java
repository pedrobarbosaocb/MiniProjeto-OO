...
public class EditPerfil extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == save_btn) {
			if(_dados.editarUsuario(ControleDados.getUsuarioSessao().getId(), txt_nome.getText(), txt_email.getText(), txt_dt_nascimento.getText(), txt_senha.getText())) {
				JOptionPane.showMessageDialog(null, "Usuário atualizado com sucesso!", null, JOptionPane.INFORMATION_MESSAGE);
				...
				JOptionPane.showMessageDialog(null, "Erro ao atualizar usuario!", null, JOptionPane.INFORMATION_MESSAGE);
