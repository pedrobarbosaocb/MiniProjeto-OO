...
public class AddAmigo extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == save_btn) {
			if(_dados.criarAmigo(ControleDados.getUsuarioSessao(), txt_nome.getText(), txt_email.getText(), txt_telefone.getText())) {
				JOptionPane.showMessageDialog(null, "Amigo cadastrado com sucesso!", null, JOptionPane.INFORMATION_MESSAGE);
